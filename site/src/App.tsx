...
import { ChainExplorer, ChainNodeHub, ChainNodeOrbit } from "../../src/chains/index.js";
    ...
    <main className="n4-app-bg">
      ...
      >
        ...
        <div style={{ marginTop: 32, display: "flex", gap: 24, flexWrap: "wrap", justifyContent: "center" }}>
          <ChainNodeOrbit analysis={CHAIN_ANALYSIS} defaultFocusToken="snv" size={470} title="Node orbit · focus at the centre" />
          <ChainNodeHub analysis={CHAIN_ANALYSIS} defaultFocusToken="snv" size={470} title="Chain hub · focus on the 2nd ring" />
        </div>
      </Section>
