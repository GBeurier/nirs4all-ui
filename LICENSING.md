# Licensing — nirs4all-ui

`nirs4all-ui` is part of the **nirs4all ecosystem** and is offered under a
...
`nirs4all-ui` relies on third-party open-source components. Their licenses are summarized
