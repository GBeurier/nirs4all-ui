...
const brands = [
  {
    ...
    palette: { primary: "#0d9488", secondary: "#06b6d4", accent: "#10b981", dark: "#0f172a", surface: "#ffffff" },
  },
  {
    id: "nirs4all-core",
    name: "nirs4all-core",
    ...
    palette: { primary: "#0d9488", secondary: "#0891b2", accent: "#4f46e5", dark: "#10233a", surface: "#ffffff" },
  },
  {
    id: "nirs4all-ui",
    name: "nirs4all-ui",
    ...
    palette: { primary: "#2563eb", secondary: "#06b6d4", accent: "#e9362d", dark: "#172554", surface: "#ffffff" },
  },
  {
    ...
    palette: { primary: "#7c3aed", secondary: "#0d9488", accent: "#f59e0b", dark: "#2e1065", surface: "#ffffff" },
  },
];
